									...
									<div class="himg">
										<c:choose>
											<c:when test="${list.hsfile1 != null}">
												<img src="http://localhost:9000/upload/${list.hsfile1}" width="122px" height="122px">
											</c:when>

											<c:when test="${list.hsfile2 != null}">
												<img src="http://localhost:9000/upload/${list.hsfile2}" width="122px" height="122px">
											</c:when>
