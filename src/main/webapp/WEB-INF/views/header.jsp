                ...
                <form name="headerSearchForm" action="/main_search" method="post">
                    <div class="header-search">
                        <div>
                            ...
                            <button type="button" id="btnMainSearch-header"><img src="http://localhost:9000/images/foot_98DFFF.png" width="30px" height="30px"></button>
                        </div>
                    </div>
                </form>
                	...
                	<c:choose>
						<c:when test="${sessionScope.svo == null}">
		                    <ul>
		                        ...
		                        <li>
		                            <a href="http://localhost:9000/review_main/1/서울전체/">리뷰사전</a>
		                        </li>
		                        <li>
