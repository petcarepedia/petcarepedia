				...
				<div>
					<nav>
						<ul>
							...
							<li><a href = "/mypage_pet_information" style="font-weight: normal">반려동물 정보</a></li>
							<li><a href = "/mypage_reservation" style="font-weight: bold">예약 내역</a></li>
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<c:forEach var = "bookingReview" items = "${list2}">
								<div id = "aside1">
									<img src = "http://localhost:9000/upload/${bookingReview.hsfile1}">
									<div>
